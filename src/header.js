  ...
  return (
    <header>
      <div class="header-container">
        <div class="logo">
          <span class="bunri-logo" onClick={handleLogoClick}>
            BUNRI
          </span>
          <span class="wiki-logo" onClick={handleLogoClick}>
            WiKi
          </span>
        </div>
        {isMobile ? (
            ...
            <div className={`mobile-menu ${isMenuOpen ? "open" : ""}`}>
              <div className="side-menu">
                <ul className="mobile-side">
                  <div class="logo">
                    <span class="bunri-logo">BUNRI</span>
          ...
          <>
            ...
            >
              ...
              {isSearchFocused && searchDetails.length > 0 && (
                <div className="related-searches">
                  {searchDetails.map((item, index) => (
                    <div key={index} className="related-search-item">
                      <span
                        onClick={() => navigateToSearch(item.name, item)}
                        style={{ cursor: "pointer" }}
                      >
                        {item.name}
                      </span>
